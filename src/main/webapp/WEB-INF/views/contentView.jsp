			...
			<td class="content_box" align="center">
				<table border="0" cellpadding="10" cellspacing="0">
						...
						<tr>
							...
							<td>
								<textarea class="text_area_view" rows="10" coler="50" name="bcontent" readonly="readonly">${bDto.bcontent }</textarea>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input class="input_box02_view" type="text" name="btdate" value="${bDto.bdate }" readonly="readonly">
							</td>
						</tr>
