					...
					<tr>
						<td colspan="5" align="right">
							<form action="list2">
								...
								<input class="search_btn01" type="submit" value="검색">
							</form>
						</td>
					</tr>
					<tr>
						...
						<td class="board_content">
							...
							<c:choose>
								<c:when test="${fn:length(bDto.btitle) > 25 }">
									<c:out value="${fn:substring(bDto.btitle, 0, 22)}"></c:out>...
								</c:when>
								<c:otherwise>
									${bDto.btitle }
								</c:otherwise>
					...
					<tr>
						<td colspan="5" align="center">
							<c:if test="${pageDto.prev }">
								...
								<a class="pagelink" href="list2?pageNum=${pageDto.startPage-10}">◀</a>
							</c:if>
							&nbsp;&nbsp;
